...
class WxPayApi
{
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/unifiedorder";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/orderquery";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/closeorder";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet()) {
	...
	{
		$url = "https://app.mch.weixin.qq.com/secapi/pay/refund";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/refundquery";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/downloadbill";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/pay/micropay";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/secapi/pay/reverse";
		//检测必填参数
		if(!$inputObj->IsOut_trade_noSet() && !$inputObj->IsTransaction_idSet()) {
	...
	{
		$url = "https://app.mch.weixin.qq.com/payitil/report";
		//检测必填参数
	...
	{
		$url = "https://app.mch.weixin.qq.com/tools/shorturl";
		//检测必填参数
